...
export const CORE_FORMULAS: CoreFormula[] = [
  ...
  },
  {
    ...
    week: 6,
    title: "טור p",
    latex: "\\sum_{n=1}^{\\infty}\\frac{1}{n^p}\\ \\operatorname{converges}\\iff p>1",
    use: "טור הייחוס המרכזי להשוואה ולהשוואה גבולית.",
    conditions: "עבור p=1 מתקבל הטור ההרמוני והוא מתבדר.",
  },
  {
    id: "limit-comparison",
    group: "series",
    ...
    latex: "\\lim_{n\\to\\infty}\\frac{a_n}{b_n}=L,\\quad 0<L<\\infty",
    use: "אחרי שמזהים את סדר הגודל של a_n ובוחרים טור ייחוס b_n.",
    conditions: "צריך a_n,b_n>0 החל ממקום מסוים; אז שני הטורים מתכנסים או מתבדרים יחד.",
    warning: "שקילות היא כלי לבחירת b_n, לא שוויון שמותר להציב בתוך הטור.",
  },
  {
    id: "geometric-series",
    group: "series",
  ...
  },
  {
    ...
    group: "series",
    week: 7,
    title: "צמצום עצרת במבחן המנה",
    latex: "(n+k)!=n!\\prod_{j=1}^{k}(n+j)",
    use: "לצמצום מהיר של a_{n+1}/a_n כשמופיעות עצרות או מכפלות.",
    conditions: "סופרים את מספר המדרגות בין העצרות ומשאירים רק את הגורמים שביניהן.",
    warning: "עצרת או מכפלה הן בדרך כלל סימן להתחיל במבחן המנה.",
  },
  {
    id: "famous-e-sequence",
    group: "sequences",
    week: 7,
    title: "הגבול המפורסם של e",
    latex: "\\lim_{n\\to\\infty}\\left(1+\\frac{a}{n}\\right)^n=e^a",
    use: "לפישוט גורמים מהצורה בסיס ששואף ל-1 בחזקה ששואפת לאינסוף.",
    conditions: "מסדרים תחילה את הביטוי כך שהחזקה והמכנה יהיו באותו קנה מידה.",
  },
  {
    id: "nth-root-n",
    group: "sequences",
    week: 7,
    title: "שורש n-י של n",
    latex: "\\lim_{n\\to\\infty}n^{1/n}=1",
    use: "גבול שחוזר כמעט בכל מבחן שורש עם גורם פולינומי.",
    conditions: "גם n^{c/n}\\to1 לכל קבוע c.",
  },
  {
    id: "integral-test",
    group: "series",
    week: 7,
    title: "מבחן האינטגרל והערכת הזנב",
    latex: "\\int_N^\\infty f(x)\\,dx\\le\\sum_{n=N}^{\\infty}f(n)\\le f(N)+\\int_N^\\infty f(x)\\,dx",
    use: "לטור a_n=f(n) כשהאינטגרל פשוט, ובמיוחד לביטוי שמכיל פונקציה ואת נגזרתה.",
    conditions: "f חיובית, רציפה ויורדת החל ממקום מסוים.",
  },
  {
    id: "logarithmic-borderline-series",
    group: "series",
    week: 7,
    title: "טורי הגבול הלוגריתמיים",
    latex: "\\sum_{n\\ge2}\\frac{1}{n(\\ln n)^p}\\ \\operatorname{converges}\\iff p>1",
    use: "כאשר טור p רגיל גס מדי והאיבר קרוב לגבול ההרמוני.",
    conditions: "מתחילים ב-n\\ge2 כדי שהלוגריתם יהיה מוגדר וחיובי.",
  },
  {
    id: "small-angle-equivalences",
    group: "limits",
    week: 7,
    title: "שקילויות יסוד ליד 0",
    latex: "\\sin x\\sim\\tan x\\sim\\arctan x\\sim\\ln(1+x)\\sim e^x-1\\sim x",
    use: "לזיהוי סדר גודל כשארגומנט קטן, במיוחד x=1/n בהשוואה גבולית.",
    conditions: "היחסים שואפים ל-1 כאשר x\\to0; עבור 1-\\cos x משתמשים ב-1-\\cos x\\sim x^2/2.",
    warning: "הסימן \\sim אינו שוויון; מצדיקים את המסקנה באמצעות גבול של מנה.",
  },
  {
    id: "ratio-test",
    group: "series",
