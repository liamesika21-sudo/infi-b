    ...
    sections: [
      ...
      },
      {
        key: "ex", icon: "✏️", title: "תרגילים ושיעורי בית ספציפיים", color: C.green, items: [
          ...
          { t: "ש״ב 2, שאלה 1 — הגדרות (גבול סדרה, מונוטוניות, חסימות) — סופר חשוב! כל מבחן נפתח בסעיף הגדרה", href: "/weeks/2", hl: "ש״ב 2" },
          { t: "ש״ב 1, שאלות 1(b), 1(d), 4(a) — לופיטל + מתי אסור לופיטל", href: "/weeks/1", hl: "ש״ב 1" },
          { t: "ש״ב 3, שאלות 1(a), 1(d), 2(a) — טכניקות: הצבת שורש, פישוט שבר, ״החזרת האינטגרל לאגף שמאל״", href: "/weeks/3", hl: "ש״ב 3" },
          { t: "ש״ב 3, שאלות 4, 5, 6 ⭐ — שאלות הוכחה שהמרצה ציין כסבירות גבוהה למבחן: $\\int \\ln(x)f'(x)dx$ עם נתון (4), מלכודת ״$0=1$״ בחלקים (5), אינטגרביליות של $f$ חסומה (6)", href: "/weeks/3", hl: "ש״ב 3" },
        ],
      },
      {
